...
1. System Design for Interviews Vol 1 & Vol 2 (Alex Xu) (Two Books)

## Kubernetes (k8s)

1. [Kubernetes Crash Course for Absolute Beginners \[NEW\] - YouTube](https://www.youtube.com/watch?v=s_o8dwzRlu4)
...
1. [Vector Databases Fundamentals to Production \[2026 Edition\]](https://www.udemy.com/course/vector-databases-ai/?couponCode=CM260417IN)
...
### Database tips & case-studies

1. [Notes: Designing data intensive applications](https://github.com/pushkar100/notes-system-design/blob/main/3-Designing-data-intensive-applications.md)
...
1. [Notes: Java](https://github.com/pushkar100/notes-java)
2. **{Done}** [Spring Boot Tutorial for Beginners \| Full Course 2025 - YouTube](https://www.youtube.com/watch?v=Cw0J6jYJtzw)
3. [Become a Java Backend Engineer with Spring Boot, Spring Security, JPA, REST APIs, Docker, AWS & Production-Ready Skills](https://www.udemy.com/course/spring-springboot-jpa-hibernate-zero-to-master/)
4. [[NEW] Master Microservices with SpringBoot,Docker,Kubernetes](https://www.udemy.com/course/master-microservices-with-spring-docker-kubernetes/)

## Kafka

1. [The Complete Apache Kafka Practical Guide](https://www.udemy.com/course/apache_kafka/?couponCode=CM260417IN)

## Interesting Tech Videos (Backend) 

1. SCALING: [Let's Handle 1 Million Requests per Second, It's Scarier Than You Think! - YouTube](https://www.youtube.com/watch?v=W4EwfEU8CGA)
...
5. SCALING: [Scaling 7M+ Postgres Tables! by Kailash Nadh CTO \@zerodha - YouTube](https://www.youtube.com/watch?v=4TE1xErXwGc)
6. POSTGRESQL: [Solving one of PostgreSQL\'s biggest weaknesses. - YouTube](https://www.youtube.com/watch?v=ruUlK6zRwS8)
